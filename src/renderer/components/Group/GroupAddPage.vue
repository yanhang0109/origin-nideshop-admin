    ...
    export default {
      ...
      methods: {
        ...
        processData (index) {
          ...
          this.infoForm.tableData[index].begin_time = (new Date(this.infoForm.begin_time).getTime() / 1000)
          this.infoForm.tableData[index].end_time = (new Date(this.infoForm.end_time).getTime() / 1000)
          ...
          this.infoForm.tableData[index].create_time = parseInt(Date.now() / 1000)
        },
        addGroup (data) {
          this.axios.post('group/store', data).then((response) => {
